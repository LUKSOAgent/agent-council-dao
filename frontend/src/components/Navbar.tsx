...
import { Code2, Upload, User, Search, Menu, X } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div
        ref={mobileMenuRef}
        id="mobile-menu"
        className={`md:hidden fixed inset-x-0 top-16 bg-slate-900/98 backdrop-blur-xl border-b border-slate-800 transition-all duration-300 ${
          mobileMenuOpen 
